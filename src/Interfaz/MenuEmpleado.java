...
public class MenuEmpleado extends javax.swing.JDialog {
     ...
     */
    public MenuEmpleado(java.awt.Frame parent, boolean modal, Conexion conexion) {
        super(parent, modal);
        initComponents();
    ...
    private void inicializarAtributos() {
        ...
        llenarTablaTodosEmpleados();
        llenarHotelIdentificacion(cmbHotelId);
        llenarDni(cmbDni1);
    ...
    public void llenarTablaTodosEmpleados() {
        ResultSet resTodos = empleado.consultarTodo();
        try {
    ...
    private void llenarHotelIdentificacion(JComboBox<String> cmb) {
        ArrayList hoteles = getValoresTabla(hotel, "HOTID");
        for (int i = 0; i < hoteles.size(); i++) {
            cmb.addItem(hoteles.get(i).toString());
        }
    }
    ...
    public int registrarEmpleado() {
        Date fecha = new Date(txtFechaIngreso.getText());
        Modelo_Empleado me = new Modelo_Empleado(Integer.parseInt(txtIdentificacion.getText()), Integer.parseInt(cmbHotelId.getSelectedItem().toString()), txtNombre.getText(), txtDireccion.getText(), fecha, null);
        return empleado.insertarEmpleados(me);
    }
    ...
    private void initComponents() {
        ...
        cmbHotelId = new javax.swing.JComboBox<>();
        ...
        jLabel2.setText("Identificación del Empleado (DNI):");

        jLabel3.setText("Nombre:");

        lblHotelId.setText("Identificación del Hotel donde trabaja:");

        lblDireccion.setText("Dirección de vivienda:");

        lblFechaInicio.setText("Fecha de Ingreso:");

        txtFechaIngreso.setText("dd-mm-aa");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(lblDireccion, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jLabel2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
                            .addComponent(jLabel3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(txtNombre, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 458, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cmbHotelId, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 457, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtDireccion, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 457, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtIdentificacion, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 457, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblFechaInicio, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtFechaIngreso, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(233, 233, 233))))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(11, 11, 11)
                .addComponent(cmbHotelId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MenuEmpleado dialog = new MenuEmpleado(new javax.swing.JFrame(), true, null);
    ...
    private javax.swing.JComboBox<String> cmbHotelId;
